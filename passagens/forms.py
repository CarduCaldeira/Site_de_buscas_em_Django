...
class PassagemForms(forms.Form):
    ...
    classe_viagem = forms.ChoiceField(label='Tipo de voo',choices=tipos_de_classe)
    informacoes = forms.CharField(label='Informaçoes extras', max_length=200, widget=forms.Textarea(),required=False)
    ...
    def clean(self):
        ...
        data_ida_maior_que_data_atual(data_ida, data_pesquisa, lista_de_erros)
